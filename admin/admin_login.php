...
<body>
    <div class="d-flex login_container">
        <div class="m-auto login_form">
            <div class="form_header d-flex flex-row justify-content-between p-3  mt-5"><h4>Admin Login</h4><a href="../index.php">Back</a></div>
            <div class="d-flex justify-content-center error"><?php if(isset($_GET['error'])) {echo $_GET['error'];} ?></div>
            <form action="../php/admin_login.inc.php" method="POST" class="form_body p-5">
